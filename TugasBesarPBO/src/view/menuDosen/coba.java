 ...
 */
public class coba  extends JPanel implements ActionListener,ViewConfig  {
    JLabel title;
    JButton DaftarHDosen;//createUser
    JButton DaftarHMahasiswa;//editUser
    JButton EditHMahasiswa;//deleteUser
    ...
    public coba(){
        setLayout(null);
        title = new JLabel("Daftar Hadir");
        title.setBounds(20, 0, 200, 60);
        title.setFont(new java.awt.Font("Segoe UI", 1, 20));
        add(title);
        
        DaftarHDosen = new JButton("Daftar Hadir Dosen");
        DaftarHDosen.setBounds(20, 60, 170 ,30);
        DaftarHDosen.setContentAreaFilled(true);
        DaftarHDosen.setBackground(COLOR_WHITE);
        DaftarHDosen.setForeground(BGCOLOR_DEFAULT);
        DaftarHDosen.setBorder(javax.swing.BorderFactory.createLineBorder(BGCOLOR_DEFAULT));
        DaftarHDosen.setFocusPainted(false);
        DaftarHDosen.setFont(FONT_DEFAULT_PLAIN );
        DaftarHDosen.addActionListener(this);
        add(DaftarHDosen);
        
        DaftarHMahasiswa = new JButton("Daftar Hadir Mahasiswa");
        DaftarHMahasiswa.setBounds(200, 60, 170 ,30);
        DaftarHMahasiswa.setContentAreaFilled(true);
        DaftarHMahasiswa.setBackground(COLOR_WHITE);
        DaftarHMahasiswa.setForeground(BGCOLOR_DEFAULT);
        DaftarHMahasiswa.setBorder(javax.swing.BorderFactory.createLineBorder(BGCOLOR_DEFAULT));
        DaftarHMahasiswa.setFocusPainted(false);
        DaftarHMahasiswa.setFont(FONT_DEFAULT_PLAIN );
        DaftarHMahasiswa.addActionListener(this);
        add(DaftarHMahasiswa);
        
        EditHMahasiswa = new JButton("Edit Daftar Hadir Mahasiswa");
        EditHMahasiswa.setBounds(380, 60, 170 ,30);
        EditHMahasiswa.setContentAreaFilled(true);
        EditHMahasiswa.setBackground(COLOR_WHITE);
        EditHMahasiswa.setForeground(BGCOLOR_DEFAULT);
        EditHMahasiswa.setBorder(javax.swing.BorderFactory.createLineBorder(BGCOLOR_DEFAULT));
        EditHMahasiswa.setFocusPainted(false);
        EditHMahasiswa.setFont(FONT_DEFAULT_PLAIN );
        EditHMahasiswa.addActionListener(this);
        add(EditHMahasiswa);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(option.equals("Tambah User")){
            menuNow = "Tambah User";
            DaftarHDosen.setBackground(BGCOLOR_DEFAULT);
            DaftarHDosen.setForeground(COLOR_WHITE);
            optionListUser.setVisible(true);
            btnTypeUser.setVisible(true);
            
         }else if(option.equals("Edit User")){
            menuNow = "Edit";
            DaftarHMahasiswa.setBackground(BGCOLOR_DEFAULT);
            DaftarHMahasiswa.setForeground(COLOR_WHITE);
            searchUser.setVisible(true);
            btnSearchEdit.setVisible(true);
         }else if(option.equals("Hapus User")){
            menuNow = "Delete";
            EditHMahasiswa.setBackground(BGCOLOR_DEFAULT);
            EditHMahasiswa.setForeground(COLOR_WHITE);
            searchUser.setVisible(true);
            btnSearchEdit.setVisible(true);
         }
